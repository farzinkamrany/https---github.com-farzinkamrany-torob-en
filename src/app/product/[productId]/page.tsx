  ...
  return (
    <StAll>
      ...
      <div className="details">
        ...
        <div className="product-overview">
          ...
          <div className="price-details">
            <div>
              <h1>{Datas?.results?.name1}</h1>
            </div>
            <div className="price-tags">
              <span>
                <b>{Datas?.results?.name2}</b>
                <p>{Datas?.results?.price_text}</p>
              </span>
              <span>
                <b>{Datas?.results?.name2}</b>
                <p>
                  <a href="#part-1">{Datas?.results?.price_text}</a>
                </p>
              </span>
            </div>
            <div className="price-and-action">
              <div className="price-help">
                <Tooltip title="from 10000000 tomans">
                  <b style={{ display: "inline-block", whiteSpace: "nowrap" }}>
                    <Button>
                      <a href="#inPerson">From 4,899,000 tomans</a>
                    </Button>
                  </b>
                </Tooltip>
              </div>
                ...
                <div>
                  {bell ? (
                    <AiFillBell
                      ...
                      style={{ fill: "rgb(215, 57, 72)" }}
                    />
                  ) : (
                    <AiOutlineBell onClick={() => setbell(!bell)} />
                  )}
                  {heart ? (
                    <AiFillHeart
                      style={{ fill: "rgb(215, 57, 72)" }}
        ...
        <div className="sellers">
          ...
          <div className="in-person" id="part-1" style={{ marginTop: 10 }}>
            <div id="onlineSellers part-1">
              <PriceCard data={Datas} />
            </div>
            <br />
            <div id="part-2">
              {" "}
      ...
      >
        {
          <AwesomeSlider
            style={{ width: "50%", margin: "0 auto", height: 550 }}
            bullets={false}
          >
